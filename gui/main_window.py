...
class KlausurApp(tk.Tk):
    ...
    def setup_ui(self):
        ...
        self.import_export_tab = ImportExportTab(notebook, self)
        ...
        notebook.add(self.import_export_tab, text="Import/Export")
    ...
    def on_modules_changed(self):
        ...
        self.import_export_tab.update_module_dropdown()
