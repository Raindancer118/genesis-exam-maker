...
from .generate_exam_tab import GenerateExamTab  # NEUER IMPORT
...
class KlausurApp(tk.Tk):
    ...
    def setup_ui(self):
        ...
        self.generate_tab = GenerateExamTab(notebook, self)  # NEUE INSTANZ

        notebook.add(self.task_tab, text="Aufgabe hinzufügen")
        notebook.add(self.manage_tab, text="Verwaltung")
        notebook.add(self.generate_tab, text="Klausur generieren")  # NEUER TAB
    ...
    def on_modules_changed(self):
        ...
        self.generate_tab.update_module_dropdown()  # NEUE ZEILE
